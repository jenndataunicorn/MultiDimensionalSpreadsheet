<Query Kind="Statements">
  ...
  <Reference Relative="..\..\AppData\Roaming\LINQPad\Samples\LINQ in Action\LinqInAction.Chapter06to08.Common.dll">&lt;ApplicationData&gt;\LINQPad\Samples\LINQ in Action\LinqInAction.Chapter06to08.Common.dll</Reference>
...
var bookParam = Expression.Parameter(typeof(LinqInAction.Chapter06to08.Common.Book), "book");
	...
	var query =
		context.Books.Where<LinqInAction.Chapter06to08.Common.Book>
		(
			Expression.Lambda<Func<LinqInAction.Chapter06to08.Common.Book, bool>>
			(
